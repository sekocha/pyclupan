...
if __name__ == "__main__":
    ...
    ps.add_argument("--dump", type=str, default=None, help="parse derivative*.pkl file")
    ps.add_argument(
        "--yaml", type=str, default=None, help="parse derivative*.yaml file"
    )
    ps.add_argument(
    ...
    print_poscar_tofile(
        cell, n_atoms, order, elements, remove_indices=remove_indices, filename=fname
    )
